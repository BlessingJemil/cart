...
import ipadpro from './images/ipadpro12.png';
import imac from './images/mba.png';
import imacst from './images/studio.jpg';
import logo from './images/23.png';
import iphone14n from './images/iphone14.jpg';
...
import maclit from './images/maclit.jpg';
import macmini from './images/macmini.jpg';
import keyboard from './images/keyboard.jpg';
import mouse from './images/magicmouse.jpg';
  ...
  return (
    <div >
      <div >
        <ul className='nav'>
          ...
          <Link to='/next' state={{to:arr}} ><li ><FontAwesomeIcon icon={faCartShopping} className='proceed' /> </li></Link>
    ...
    <div className="App">
      ...
      <div className={iph3}>
        ...
        <h2>Apple Studio Display - Nano-Texture Glass - Tilt- and Height-Adjustable Stand</h2>
